...
function send0(){
  ...
  if(answer == "A,B,E,I"){
    if(getCookieByName('Q0') != 'done'){
      swal("答對了！", "恭喜你獲得X道具一個", "success");
      document.cookie = 'Q0=done;path=/';
    }else{
      swal("答對了！", "但你已經獲得X道具過囉，可以去找找其他道具喔！", "success");
    }
...
//     swal("答對了！", "恭喜你獲得C道具一個", "success");
//     document.cookie = 'Q3=done;path=/';
    
//   }else{
//     swal("答對了！", "但你已經獲得C道具過囉，可以去找找其他道具喔！", "success");
//   }
// }
