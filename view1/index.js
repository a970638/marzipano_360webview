...
function send1(){
  ...
  if(answer == "b"){
    if(getCookieByName('Q1') != 'done'){
      swal("答對了！", "恭喜你獲得A道具一個", "success");
      document.cookie = 'Q1=done;path=/';
    }else{
      swal("答對了！", "但你已經獲得A道具過囉，可以去找找其他道具喔！", "success");
    }
...
function send1_2(){
  var answer = document.querySelector('input[name="selection1"]:checked').value;
  if(answer == "c"){
    if(getCookieByName('Q1_1') != 'done'){
      swal("答對了！", "恭喜你獲得Y道具一個", "success");
      document.cookie = 'Q1_1=done;path=/';
    }else{
      swal("答對了！", "但你已經獲得Y道具過囉，可以去找找其他道具喔！", "success");
    }
...
//   var answer = document.querySelector('input[name="selection"]:checked').value;
//   if(answer == "b"){
//     if(getCookieByName('Q1_2') != 'done'){
//       swal("答對了！", "恭喜你獲得XX道具一個", "success");
//       document.cookie = 'Q1=done;path=/';
//     }else{
//       swal("答對了！", "但你已經獲得XX道具過囉，可以去找找其他道具喔！", "success");
//     }
