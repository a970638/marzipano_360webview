...
scene.hotspotContainer().createHotspot(document.querySelector("#info"), { yaw: 1.5, pitch: 0.30 });
...
// scene.hotspotContainer().createHotspot(document.querySelector("#info2"), { yaw: 2.5, pitch: 0.30 });

// document.querySelector("#info2 .icon_wrapper2").addEventListener('click', function() {
//   document.querySelector("#info2").classList.toggle('expanded');
//   document.querySelector("#inner_icon2").classList.toggle('closeIcon');
// });

// document.querySelector("#info2 .close").addEventListener('click', function() {
//   document.querySelector("#info2").classList.remove('expanded');
//   document.querySelector("#inner_icon2").classList.remove('closeIcon');
// });


// document.querySelector('#info2 input[type="text"]').addEventListener('keydown', function(evt) {
//   evt.stopPropagation();
// });